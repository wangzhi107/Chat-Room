...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RecvThread_t, stringdata) + ofs \
...
void RecvThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RecvThread::RecvSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject RecvThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_RecvThread.data,
      qt_meta_data_RecvThread,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void RecvThread::RecvSignal(QString _t1)
{
